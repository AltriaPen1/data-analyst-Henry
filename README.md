...
Objective: This exercise is to help us master how to convert business questions into data questions and implement them. In this process, we use the Sales_SSOT dataset as an example. We have six categories and a total of 18 business questions for practice. The ultimate goal is to verify whether these assumptions are valid or obtain corresponding numerical conclusions.
Dataset: The dataset includes sales data, temperature data, market data, customer behavior data, website traffic data and Outlier flag data of SSOT from the same periods as January to March for 2023 and 2024, containing the following key features:
